...
public class indianationrss extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new indianationrss.ProcessInBackground().execute();
    }
    ...
    public class ProcessInBackground extends AsyncTask<Integer,Integer, Exception> {
        ...
        ProgressDialog progressDialog=new ProgressDialog(indianationrss.this);
        Exception exception;
        @Override
        ...
        protected Exception doInBackground(Integer... params) {
            try{
                URL url=new URL("http://indianexpress.com/section/india/feed/");
