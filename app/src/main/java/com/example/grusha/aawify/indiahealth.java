...
public class indiahealth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new indiahealth.ProcessInBackground().execute();
    }
    ...
    public class ProcessInBackground extends AsyncTask<Integer,Integer, Exception> {
        ...
        ProgressDialog progressDialog=new ProgressDialog(indiahealth.this);
        Exception exception;
        @Override
        ...
        protected Exception doInBackground(Integer... params) {
            try{
                URL url=new URL("http://indianexpress.com/section/lifestyle/health/feed/");
